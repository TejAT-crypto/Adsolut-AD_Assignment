...
!function(e, t) {
    ...
    var o = function(e, t) {
      ...
      , s = function(e, t) {
        e.ads.isInAdMode() ? e.ads.isContentResuming() ? (o(0, t),
        e.trigger("resumeended")) : r(e, "ad", t) : e.ads._contentHasEnded || e.ads.stitchedAds() || (r(e, "content", t),
        ...
        !function(n) {
            if (e.dom.isInFrame() && "function" != typeof t.__tcfapi) {
                ...
                t.addEventListener("message", function(e) {
                    ...
                    n && "function" == typeof r[n.callId] && (r[n.callId](n.returnValue, n.success),
                    r[n.callId] = null)
                }, !1)
            }
        }(),
    ...
    g.processAdTrack = function(t, n, a, o) {
        ...
        for (var r = 0; r < n.length; r++) {
            ...
            var d = this.getCueId(t, i)
              , l = i.startTime;
            if (y(t, d))
                return void e.log("Skipping ad already seen with ID " + d);
            o && o(t, s, d, l),
            a(t, s, d, l),
            v(t, d)
        }
    ...
    var M = {
        start: function(t) {
            ...
            t.ads.shouldTakeSnapshots() && (t.ads.snapshot = function(t) {
                ...
                return i.suppressedTracks = r,
                i
            }(t)),
            t.ads.shouldPlayContentBehindAd(t) && (t.ads.preAdVolume_ = t.volume(),
            t.volume(0)),
            ...
            t.ads.shouldTakeSnapshots() ? function(t, n) {
                ...
                !0 === t.ads.disableNextSnapshotRestore)
                    ...
                    void n();
                var o, r = t.$(".vjs-tech"), i = 20, s = a.suppressedTracks, d = function() {
                ...
                if ("style"in a && r.setAttribute("style", a.style || ""),
            ...
            }(t, n) : (t.volume(t.ads.preAdVolume_),
            n())
        }
    }
      , j = function(t) {
    ...
    var F = A.isMiddlewareMediatorSupported
      ...
      , q = function(o) {
        ...
        r.on("nopreroll", function() {
            r.ads.debug("Received nopreroll event"),
            r.ads.nopreroll_ = !0
        }),
        r.on("nopostroll", function() {
            r.ads.debug("Received nopostroll event"),
            r.ads.nopostroll_ = !0
        }),
        r.on("playing", function() {
            r.ads._cancelledPlay = !1,
            r.ads._pausedOnContentupdate = !1
        }),
        r.on("play", function() {
        ...
        i.stitchedAds ? r.ads._state = new (k.getState("StitchedContentPlayback"))(r) : r.ads._state = new (k.getState("BeforePreroll"))(r),
        r.ads._state.init(r),
        ...
        r.ads.adMacroReplacement = function(a, o, r) {
            ...
            d["{mediainfo.duration}"] = this.mediainfo ? this.mediainfo.duration : "",
            d["{player.duration}"] = this.duration(),
            d["{player.pageUrl}"] = e.dom.isInFrame() ? n.referrer : t.location.href,
            d["{playlistinfo.id}"] = this.playlistinfo ? this.playlistinfo.id : "",
            d["{playlistinfo.name}"] = this.playlistinfo ? this.playlistinfo.name : "",
            ...
            for (var u in a = a.replace(/{pageVariable\.([^}]+)}/g, function(n, a) {
                ...
                var u = typeof r;
                return null === r ? "null" : void 0 === r ? s["{pageVariable." + a + "}"] ? s["{pageVariable." + a + "}"] : (e.log.warn('Page variable "' + a + '" not found'),
                "") : "string" !== u && "number" !== u && "boolean" !== u ? (e.log.warn('Page variable "' + a + '" is not a supported type'),
                "") : h(String(r), o)
            }),
            s)
                a = a.replace(u, s[u]);
        ...
        r.on("dispose", function() {
            r.ads.reset(),
            r.textTracks().removeEventListener("change", d)
        }),
        f(),
        r.ads.listenToTcf = f
    };
    return q.VERSION = a,
    function(t) {
        !b(e) && ((e.registerPlugin || e.plugin)("ads", t),
        P() && !e.usingContribAdsMiddleware_ && (e.use("*", _),
